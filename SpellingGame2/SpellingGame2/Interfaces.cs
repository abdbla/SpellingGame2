...
namespace SpellingGame2
{
    interface IUserInterface
    {
        ...
        public void WriteIntoDescription(string description);
        public void WriteIntoDescription(string description, ConsoleColor foreground, ConsoleColor background);
